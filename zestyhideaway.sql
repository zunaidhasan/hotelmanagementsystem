...
-- User: `zestyhideaway_user`
-- Password:   `password`
--
DROP DATABASE IF EXISTS zestyhideawayhotel;
CREATE DATABASE IF NOT EXISTS zestyhideawayhotel;

DROP USER IF EXISTS'zestyhideaway_user'@'%';
CREATE USER IF NOT EXISTS 'zestyhideaway_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON zestyhideawayhotel.* TO 'zestyhideaway_user'@'%';
USE zestyhideawayhotel;
...
(41, 'Zunaid Hasan', 'zunaidhasan.cse@gmail.com', 'Bangladesh', '01960569957', 'Single Room', 'Single', 'Room only', '1', '2024-11-25', '2024-11-26', 1, 'Confirm');
...
(1, 'Zunaid Hasan', 'zunaidhasan.cse@gmail.com', '123');
...
(1, 'Zunaid Hasan', 'Manager'),
(3, 'Abdullah', 'Receptionist'),
(4, 'Sadman', 'Shef'),
(5, 'Anaf', 'Helper'),
(6, 'Shagor', 'Helper'),
(7, 'Shyam', 'Cleaner'),
